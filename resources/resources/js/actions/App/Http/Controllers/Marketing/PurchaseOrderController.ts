 ...
 * @route '/marketing/purchase-order'
 */
 ...
 * @route '/marketing/purchase-order/create'
 */
...
create.definition = {
    methods: ["get","head"],
    url: '/marketing/purchase-order/create',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/marketing/purchase-order/{noPo}/edit'
 */
...
edit.definition = {
    methods: ["get","head"],
    url: '/marketing/purchase-order/{noPo}/edit',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/marketing/purchase-order/{noPo}/print'
 */
...
print.definition = {
    methods: ["get","head"],
    url: '/marketing/purchase-order/{noPo}/print',
} satisfies RouteDefinition<["get","head"]>
 ...
 * @route '/marketing/purchase-order/{noPo}'
 */
...
update.definition = {
    methods: ["put"],
    url: '/marketing/purchase-order/{noPo}',
...
/**
* @see \App\Http\Controllers\Marketing\PurchaseOrderController::updateDetail
 * @see app/Http/Controllers/Marketing/PurchaseOrderController.php:364
 * @route '/marketing/purchase-order/{noPo}/detail/{detailId}'
 */
export const updateDetail = (args: { noPo: string | number, detailId: string | number } | [noPo: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
...
updateDetail.definition = {
    methods: ["put"],
    url: '/marketing/purchase-order/{noPo}/detail/{detailId}',
} satisfies RouteDefinition<["put"]>
 ...
 * @route '/marketing/purchase-order/{noPo}/detail/{detailId}'
 */
updateDetail.url = (args: { noPo: string | number, detailId: string | number } | [noPo: string | number, detailId: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    noPo: args[0],
                    detailId: args[1],
 ...
 * @route '/marketing/purchase-order/{noPo}/detail/{detailId}'
 */
updateDetail.put = (args: { noPo: string | number, detailId: string | number } | [noPo: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: updateDetail.url(args, options),
    method: 'put',
})
 ...
 * @route '/marketing/purchase-order/{noPo}/detail/{detailId}'
 */
    const updateDetailForm = (args: { noPo: string | number, detailId: string | number } | [noPo: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/marketing/purchase-order/{noPo}/detail/{detailId}'
 */
        updateDetailForm.put = (args: { noPo: string | number, detailId: string | number } | [noPo: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateDetail.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const PurchaseOrderController = { index, create, edit, print, store, update, updateDetail }
