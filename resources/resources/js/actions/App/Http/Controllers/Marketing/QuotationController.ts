...
/**
* @see \App\Http\Controllers\Marketing\QuotationController::updateDetail
 * @see app/Http/Controllers/Marketing/QuotationController.php:294
 * @route '/marketing/quotation/{noPenawaran}/detail/{detailId}'
 */
export const updateDetail = (args: { noPenawaran: string | number, detailId: string | number } | [noPenawaran: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: updateDetail.url(args, options),
    method: 'put',
})
 ...
 * @route '/marketing/quotation/{noPenawaran}/detail/{detailId}'
 */
updateDetail.url = (args: { noPenawaran: string | number, detailId: string | number } | [noPenawaran: string | number, detailId: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    noPenawaran: args[0],
                    detailId: args[1],
    ...
    return updateDetail.definition.url
            .replace('{noPenawaran}', parsedArgs.noPenawaran.toString())
 ...
 * @route '/marketing/quotation/{noPenawaran}/detail/{detailId}'
 */
updateDetail.put = (args: { noPenawaran: string | number, detailId: string | number } | [noPenawaran: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: updateDetail.url(args, options),
    method: 'put',
})
 ...
 * @route '/marketing/quotation/{noPenawaran}/detail/{detailId}'
 */
    const updateDetailForm = (args: { noPenawaran: string | number, detailId: string | number } | [noPenawaran: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: updateDetail.url(args, {
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'PUT',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/marketing/quotation/{noPenawaran}/detail/{detailId}'
 */
        updateDetailForm.put = (args: { noPenawaran: string | number, detailId: string | number } | [noPenawaran: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateDetail.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    updateDetail.form = updateDetailForm
/**
* @see \App\Http\Controllers\Marketing\QuotationController::destroyDetail
 * @see app/Http/Controllers/Marketing/QuotationController.php:321
 * @route '/marketing/quotation/{noPenawaran}/detail/{detailId}'
 */
export const destroyDetail = (args: { noPenawaran: string | number, detailId: string | number } | [noPenawaran: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroyDetail.url(args, options),
    method: 'delete',
})

destroyDetail.definition = {
    methods: ["delete"],
    url: '/marketing/quotation/{noPenawaran}/detail/{detailId}',
 ...
 * @route '/marketing/quotation/{noPenawaran}/detail/{detailId}'
 */
destroyDetail.url = (args: { noPenawaran: string | number, detailId: string | number } | [noPenawaran: string | number, detailId: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    noPenawaran: args[0],
                    detailId: args[1],
    ...
    return destroyDetail.definition.url
            .replace('{noPenawaran}', parsedArgs.noPenawaran.toString())
            .replace('{detailId}', parsedArgs.detailId.toString())
            .replace(/\/+$/, '') + queryParams(options)
}
 ...
 * @route '/marketing/quotation/{noPenawaran}/detail/{detailId}'
 */
destroyDetail.delete = (args: { noPenawaran: string | number, detailId: string | number } | [noPenawaran: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroyDetail.url(args, options),
    method: 'delete',
})
 ...
 * @route '/marketing/quotation/{noPenawaran}/detail/{detailId}'
 */
    const destroyDetailForm = (args: { noPenawaran: string | number, detailId: string | number } | [noPenawaran: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
        action: destroyDetail.url(args, {
                    [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                        _method: 'DELETE',
                        ...(options?.query ?? options?.mergeQuery ?? {}),
                    }
 ...
 * @route '/marketing/quotation/{noPenawaran}/detail/{detailId}'
 */
        destroyDetailForm.delete = (args: { noPenawaran: string | number, detailId: string | number } | [noPenawaran: string | number, detailId: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroyDetail.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
    ...
    destroyDetail.form = destroyDetailForm
/**
...
const QuotationController = { index, create, edit, print, update, updateDetail, destroyDetail, store }
