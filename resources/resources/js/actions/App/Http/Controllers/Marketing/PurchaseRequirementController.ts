...
/**
* @see \App\Http\Controllers\Marketing\PurchaseRequirementController::updateDetail
 ...
 */
export const updateDetail = (args: { noPr: string | number, detailNo: string | number } | [noPr: string | number, detailNo: string | number ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
 ...
 * @route '/marketing/purchase-requirement/{noPr}/detail/{detailNo}'
 */
updateDetail.url = (args: { noPr: string | number, detailNo: string | number } | [noPr: string | number, detailNo: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    noPr: args[0],
                    detailNo: args[1],
 ...
 * @route '/marketing/purchase-requirement/{noPr}/detail/{detailNo}'
 */
updateDetail.put = (args: { noPr: string | number, detailNo: string | number } | [noPr: string | number, detailNo: string | number ], options?: RouteQueryOptions): RouteDefinition<'put'> => ({
    url: updateDetail.url(args, options),
    method: 'put',
})
 ...
 * @route '/marketing/purchase-requirement/{noPr}/detail/{detailNo}'
 */
    const updateDetailForm = (args: { noPr: string | number, detailNo: string | number } | [noPr: string | number, detailNo: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/marketing/purchase-requirement/{noPr}/detail/{detailNo}'
 */
        updateDetailForm.put = (args: { noPr: string | number, detailNo: string | number } | [noPr: string | number, detailNo: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: updateDetail.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'PUT',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
/**
* @see \App\Http\Controllers\Marketing\PurchaseRequirementController::destroyDetail
 * @see app/Http/Controllers/Marketing/PurchaseRequirementController.php:297
 * @route '/marketing/purchase-requirement/{noPr}/detail/{detailNo}'
 */
export const destroyDetail = (args: { noPr: string | number, detailNo: string | number } | [noPr: string | number, detailNo: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
 ...
 * @route '/marketing/purchase-requirement/{noPr}/detail/{detailNo}'
 */
destroyDetail.url = (args: { noPr: string | number, detailNo: string | number } | [noPr: string | number, detailNo: string | number ], options?: RouteQueryOptions) => {
    if (Array.isArray(args)) {
        args = {
                    noPr: args[0],
                    detailNo: args[1],
 ...
 * @route '/marketing/purchase-requirement/{noPr}/detail/{detailNo}'
 */
destroyDetail.delete = (args: { noPr: string | number, detailNo: string | number } | [noPr: string | number, detailNo: string | number ], options?: RouteQueryOptions): RouteDefinition<'delete'> => ({
    url: destroyDetail.url(args, options),
    method: 'delete',
})
 ...
 * @route '/marketing/purchase-requirement/{noPr}/detail/{detailNo}'
 */
    const destroyDetailForm = (args: { noPr: string | number, detailNo: string | number } | [noPr: string | number, detailNo: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
 ...
 * @route '/marketing/purchase-requirement/{noPr}/detail/{detailNo}'
 */
        destroyDetailForm.delete = (args: { noPr: string | number, detailNo: string | number } | [noPr: string | number, detailNo: string | number ], options?: RouteQueryOptions): RouteFormDefinition<'post'> => ({
            action: destroyDetail.url(args, {
                        [options?.mergeQuery ? 'mergeQuery' : 'query']: {
                            _method: 'DELETE',
                            ...(options?.query ?? options?.mergeQuery ?? {}),
...
const PurchaseRequirementController = { index, create, edit, store, update, updateDetail, destroyDetail, print }

export default PurchaseRequirementController